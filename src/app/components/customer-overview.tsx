      ...
      <div className='max-w-6xl mx-auto px-4'>
        ...
        <div className='grid lg:grid-cols-3 gap-6'>
          <section className='lg:col-span-2 bg-white border border-[#2d2a26] rounded-2xl p-6'>
            ...
            {loading ? (
              <p className='text-sm text-[#7a756e]'>Đang tải lịch hẹn...</p>
            ) : nextAppointment ? (
            ...
            <div className='space-y-3'>
              {pets.map((pet) => (
                <div key={pet.id} className='p-3 rounded-xl border border-[#2d2a26]/20 bg-[#faf9f6]'>
                  <p className='text-[#2d2a26]' style={{ fontWeight: 700 }}>
                    {pet.name}
                  </p>
              ...
              {!loading && pets.length === 0 ? <p className='text-sm text-[#7a756e]'>Bạn chưa có thú cưng nào.</p> : null}
            </div>
