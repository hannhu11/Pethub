...
function getStatusColor(status: AppointmentStatus) {
  ...
  return 'bg-white text-[#592518] border-[#592518]/20';
}
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
        ...
        <div className='relative'>
          ...
          <input
            ...
            className='pl-9 pr-4 py-2 border border-[#592518] rounded-xl bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#d56756] w-72'
          />
        </div>
      </div>
            ...
            <thead>
              <tr className='border-b border-[#592518]'>
                {['Giờ', 'Ngày', 'Khách hàng', 'SĐT', 'Thú cưng', 'Dịch vụ', 'Trạng thái', 'Thanh toán', 'Hành động'].map((header) => (
                  <th key={header} className='text-left py-3 px-3 text-xs text-[#8b6a61] whitespace-nowrap'>
                    {header}
                  </th>
                ))}
              </tr>
              ...
              {filtered.map((booking, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className='py-3 px-3 text-[#8b6a61]'>{booking.customer?.phone ?? '--'}</td>
                      ...
                      <span
                        className={`inline-block text-xs px-3 py-1 rounded-lg border whitespace-nowrap ${
                          isPaid
                            ...
                            : 'bg-[#f6eee7] text-[#8b6a61] border-[#592518]/15'
                        }`}
                      >
                      ...
                      <div className='flex flex-wrap gap-1.5'>
                        ...
                        {booking.status === 'confirmed' ? (
                          <>
                            <button
                              ...
                              disabled={isWorking}
                              className='px-2.5 py-1 rounded-lg text-xs border border-[#592518]/20 bg-white text-[#592518] disabled:opacity-60'
                            >
                              Hoàn tất khám
                            </button>
                            <button
                        ...
                        {booking.status === 'completed' && !isPaid ? (
                          <button
                            ...
                            className='px-2.5 py-1 rounded-lg text-xs border border-[#592518] bg-[#d56756] text-white'
