  ...
  return (
    <div className='py-12'>
      <div className='max-w-3xl mx-auto px-4'>
        ...
        <div className='mx-auto max-w-2xl rounded-3xl overflow-hidden border border-[#2d2a26] relative bg-[#1f2327] text-white shadow-none'>
          ...
          <div className='relative z-10 p-6 md:p-7'>
            ...
            {pet.specialNotes && (
              <p className='mt-3 text-xs text-white/85'>
                <span className='text-white/65'>Lưu ý:</span> {pet.specialNotes}
              </p>
            )}
          </div>
        </div>
